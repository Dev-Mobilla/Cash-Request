...
const getAppValCash = (element) => {
    let appVal;
    if (element.rm_status == 'approved' && element.ram_status == '') {
        appVal = 40
    }
    else if (element.ram_status == 'approved' && element.ass_status == '') {

        appVal = 60
    }
    else if (element.ass_status == 'approved' && element.vpo_status == '') {

        appVal = 80
    }
    else if (element.vpo_status == 'approved') {
                        ...
                        for (let index = 0; index < rows.length; index++) {
                            ...
                            if (req.body.IsApprover) {
                                if (req.body.status == "approved") {
                                    ...
                                    // if (element.rm_status == 'disapproved' && element.ram_status == '') {
                                    //     appVal = 40
                                    // }
                                    // else if (element.ram_status == 'disapproved' && element.ass_status == '') {
    
                                    //     appVal = 60
                                    // }
                                    // else if (element.ass_status == 'disapproved' && element.vpo_status == '') {
    
                                    //     appVal = 80
                                    // }
                                    // else if (element.vpo_status == 'disapproved') {
                                ...
                                if (req.body.status == "approved") {
                                    if (!element.area_approver == '' && element.am_status == 'approved' && element.rm_status == '') {
                                        appVal = 20
                                    }
                                    else if (!element.regional_approver == '' && element.rm_status == 'approved' && element.am_status == 'approved' && element.ram_status == '') {
    
                                        appVal = 40
                                    }
                                    else if (!element.ram_approver == '' && element.ram_status == 'approved' && element.am_status == 'approved' && element.rm_status == 'approved' && element.ass_status == '') {
    
                                        appVal = 60
                                    }
                                    else if (!element.ass_vpo_approver == '' && element.ass_status == 'approved' && element.am_status == 'approved' && element.rm_status == 'approved' && element.ram_status == 'approved' && element.vpo_status == '') {
    
                                        appVal = 80
                                    } 
                                    else if (!element.ass_vpo_approver == '' && element.ass_status == 'approved' && element.am_status == 'approved' && element.rm_status == 'approved' && element.ram_status == 'approved' && element.vpo_status == 'approved') {
                                    ...
                                    if (!element.area_approver == '' && element.am_status == 'disapproved' && element.rm_status == '') {
                                        appVal = 20
                                    }
                                    else if (!element.regional_approver == '' && element.rm_status == 'disapproved' && element.am_status == 'disapproved' && element.ram_status == '') {
    
                                        appVal = 40
                                    }
                                    else if (!element.ram_approver == '' && element.ram_status == 'disapproved' && element.am_status == 'disapproved' && element.rm_status == 'disapproved' && element.ass_status == '') {
    
                                        appVal = 60
                                    }
                                    else if (!element.ass_vpo_approver == '' && element.ass_status == 'disapproved' && element.am_status == 'disapproved' && element.rm_status == 'disapproved' && element.ram_status == 'disapproved' && element.vpo_status == '') {
    
                                        appVal = 80
                                    } 
                                    else if (!element.ass_vpo_approver == '' && element.ass_status == 'disapproved' && element.am_status == 'disapproved' && element.rm_status == 'disapproved' && element.ram_status == 'disapproved' && element.vpo_status == 'disapproved') {
                    ...
                    if (!rows.length == 0) {
                        for (let index = 0; index < rows.length; index++) {
                            ...
                            if (req.body.IsApprover) {
                                ...
                                if (req.body.status == "approved") {
                                    if (!element.am_approver == '' && element.am_status == 'approved' && element.rm_status == '') {
                                        appVal = 20
                                    }
                                    else if (!element.rm_approver == '' && element.rm_status == 'approved' && element.am_status == 'approved' && element.ram_status == '') {
                                        appVal = 40
                                    }
                                    else if (!element.ram_approver == '' && element.ram_status == 'approved' && element.am_status == 'approved' && element.rm_status == 'approved' && element.ass_status == '') {
                                        appVal = 60
                                    ...
                                    if (!element.am_approver == '' && element.am_status == 'disapproved' && element.rm_status == '') {
                                        appVal = 20
                                    }
                                    else if (!element.rm_approver == '' && element.rm_status == 'disapproved' && element.am_status == 'disapproved' && element.ram_status == '') {
                                        appVal = 40
                                    }
                                    else if (!element.ram_approver == '' && element.ram_status == 'disapproved' && element.am_status == 'disapproved' && element.rm_status == 'disapproved' && element.ass_status == '') {
                                        appVal = 60
                                    }
                                    else if (!element.ass_vpo_approver == '' && element.ass_status == 'disapproved' && element.am_status == 'disapproved' && element.rm_status == 'disapproved' && element.ram_status == 'approved' && element.vpo_status == '') {
                                        appVal = 80
                                    } else {

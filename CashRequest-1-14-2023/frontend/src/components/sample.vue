        ...
        <table
            ...
            <tbody>
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td
                        style="width:30%;font: 14px 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;word-wrap: break-word; word-break: break-all;padding: 5px;">
                        January 2022</td>
                </tr>
                <tr>
                    <td
...
export default {
    ...
    data() {
        return {
            data: {
                amount: "541564",
                author: "ARTURO ABELLANOSA JR.",
                branch: "ML CENTRUM OSMENA",
                controlNo: "RF-221208-000005",
                date: "2022-12-07",
                region: "CEBU CENTRAL B",
                requestType: "Cash Advance",
                requestor: "ARTURO ABELLANOSA JR.",
                status: "CLOSED"
            },
            approvers: [
                {
                    approver: "area_approver",
                    date: "12/15/2022 | 2:36 PM",
                    name: "Rafael jaime A. Gayo",

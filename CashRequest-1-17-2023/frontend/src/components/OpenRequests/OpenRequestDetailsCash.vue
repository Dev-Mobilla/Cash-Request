            ...
            <table style="border-collapse: collapse; width: 85%;margin:auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        style="width:42.5%;word-wrap: break-word; word-break: break-all;font-weight: 400;border-top: none;border-bottom: 1px solid #b6b4b4;border-left: 1px solid #b6b4b4;border-right: 1px solid #b6b4b4; text-align: center;padding: 6px 8px 6px 8px;;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
                    font-size: 11px">
                            <p style="font-style:italic;text-transform:capitalize;">
                                <span style="color: red;" v-if="!approver.remarks == ''">*</span>
                                {{ approver.remarks }}
...
export default {
    ...
    methods: {
            ...
            if (response.status == 200) {
                if (response.data.resCode == 5) {
                    ...
                    if (!response.data.request.length == 0) {
                        ...
                        console.log(response.data.approvers);
        ...
        async cancelRequest() {
            ...
            const res = await store.dispatch('CancelCashRequest', { controlNo: controlNo })

            ...
            <v-col>
                <v-form>
                    <div class="mt-5 mb-10">
                        ...
                        <v-row>
                            <v-text-field class="ml-2 mr-2 text-field" v-model="cashAdvanceFormDetails.area"
                                label="Area" outlined dense readonly :background-color="inputBackGround">
                            </v-text-field>
                        ...
                        <v-row>
                            <v-text-field class="ml-2 mr-2 text-field" v-model="cashAdvanceFormDetails.date"
                                label="Date" outlined dense readonly :background-color="inputBackGround">
                            </v-text-field>
                            ...
                            <v-text-field class="ml-2 mr-2 text-field" v-model="cashAdvanceFormDetails.arrivalDate"
                                label="Estimated Arrival Date" outlined dense readonly
                                :background-color="inputBackGround">
                            </v-text-field>
                        </v-row>
                        <v-row>

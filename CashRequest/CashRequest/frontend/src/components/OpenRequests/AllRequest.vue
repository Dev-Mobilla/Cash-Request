<template>
    ...
    <div class="ml-4 mr-4 pb-10 mt-5">
        <h2>OPEN REQUESTS</h2>
        <TotalApprovedAmount  v-show="this.$store.getters.getIsApprover"/>
        <v-data-table :search="search" :custom-filter="filter" :headers="headers" :items="allRequest"
            ...
            <template v-slot:top>
                <v-row style="margin:10px 0px 0px 0px;" align="center">
                    <v-col style="padding: 0px;">
                        ...
                        <v-select @change="selectedChange($event)" v-model="selectedItem" :items="items" dense outlined
                            solo id="showEntries"></v-select>
                    </v-col>
                    <!-- <div>
                    ...
                    <v-spacer></v-spacer>
                    <v-spacer></v-spacer>
                    <v-text-field v-model="search" @input="onSearch" append-icon="mdi-magnify" label="Search"
            ...
            <template v-slot:[`item`]="{ item }">
                <tr>
                    ...
                    <td style="font-size: 11px;text-align: center;align-content: center;">
                ...
                'green darken-3' : item.requestType === 'Revolving Fund' ?
                    ...
                    <td style="font-size: 11px;overflow-x: hidden;">
                        {{ item.requestor }}
                    </td>
                    <td>

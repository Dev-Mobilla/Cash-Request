<template>
    <div style="display: flex;justify-content: end;">
        ...
        <v-col style="text-align: baseline;">
            <h4 ref="approvedThisMonth">{{ approvedThisMonthVal == null ? approvedThisMonthVal : approvedThisMonthVal.toLocaleString() }}</h4>
            <h4 ref="totalApproved">{{ approvedTotalVal == null ? approvedTotalVal : approvedTotalVal.toLocaleString() }}</h4>
        </v-col>

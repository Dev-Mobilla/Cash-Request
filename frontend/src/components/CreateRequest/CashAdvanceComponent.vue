                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col>
                                        <v-menu v-model="modal" :close-on-content-click="false" :nudge-right="40"
                                            ...
                                            <v-date-picker v-model="formData.travelDate"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col>
                                        <v-menu v-model="modal2" :close-on-content-click="false" :nudge-right="40"
                                            ...
                                            <v-date-picker v-model="formData.departureDate"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col>
                                        <v-menu v-model="modal3" :close-on-content-click="false" :nudge-right="40"
                                            ...
                                            <v-date-picker v-model="formData.arrivalDate"
                                                @input="modal3 = false"></v-date-picker>
                                            <!-- <v-date-picker 
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col cols="6" style="padding-bottom: 5px;padding-top: 0px;">
                                        <v-text-field outlined dense :rules="[RequiredRules.amount]"
                                            ...
                                            @keydown="onkeydownAmount($event)" @change="amountChange"></v-text-field>
                                    </v-col>
                                </v-row>
                            </v-col>
                        </v-row>
                    ...
                    <v-dialog v-model="dialog" width="350" persistent>
                        <v-card class="pt-5 pb-5">
                            ...
                            <v-card-text style="font-size: 15px;">
                                You are about to submit request: <p style="margin-top: 2px;font-weight: 500;">{{
                                    formData.controlNo }}</p>
                            </v-card-text>
                            <v-row dense justify="center" style="margin: 0px 20px;">
                                <v-btn height="32px" rounded small block color="primary" @click="submitForm"
...
export default {
    ...
    computed: {
        dateNow() {
            let reqDate = this.formData.date;
    ...
    methods: {
        ...
        amountChange() {
            ...
            this.formData.amount = amount.toLocaleString("en", { useGrouping: true, minimumFractionDigits: 2 })
        },
        onkeydownAmount(e) {
            ...
            if (res.status == 200) {
                ...
                if (res.code == "ERR_BAD_REQUEST") {
                    setTimeout(() => {
                        ...
                        router.push({ path: '/error', query: { message: res.response.data.message } })
                    }, 2000)
                    
                }else if (res.code == "ERR_NETWORK") {
                    setTimeout(() => {
                   
                    router.push({ path: '/error', query: { message: res.message } })
        ...
        generateDate() {
            // let dateInstance = new Date();
            // console.log(dateInstance.valueOf());
        ...
        submitForm() {
            ...
            this.formData.areaCode = sesData.areaCode

                        ...
                        <v-row>
                            <v-col style="padding:0px">
                                ...
                                <v-col cols="7" style="padding-bottom: 5px; padding-top: 0px;">
                                    <v-select :items="requestorType" readonly dense outlined v-model="rfFormData.type"
                                ...
                                <v-col cols="7" style="padding-bottom: 5px; padding-top: 0px;">
                                    <v-text-field outlined dense :rules="[RequiredRules.email]"
                                        v-model="rfFormData.email" readonly
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <!-- <v-col cols="7" style="padding-bottom: 5px;padding-top: 0px;">
                                        <v-text-field outlined dense :rules="[RequiredRules.period]"
                                            v-model="rfFormData.period" :placeholder="year"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col cols="7" style="padding-bottom: 5px; padding-top: 0px;">
                                        <!-- <v-text-field outlined dense :rules="[RequiredRules.rfAllowance]"
                                            ...
                                            @keydown="onkeydownAmount($event)" @input="onChangeAllownce($event)">
                                        </v-text-field> -->
                                        <v-text-field outlined dense :rules="[RequiredRules.rfAllowance]"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col cols="7" style="padding-bottom: 5px; padding-top: 0px;">
                                        <!-- <v-text-field outlined dense :rules="[RequiredRules.transpo]"
                                            v-model="rfFormData.transpo" ref="inPutFields"
                                            :background-color="rfFormData.transpo ? inputBackGround : ''"
                                            @keydown="onkeydownAmount($event)" @input="onChangeTranspo($event)"></v-text-field> -->
                                        <v-text-field outlined dense :rules="[RequiredRules.transpo]"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col cols="7" style="padding-bottom: 5px;padding-top: 0px;">
                                        <!-- <v-text-field outlined dense :rules="[RequiredRules.supplies]"
                                            ...
                                            @keydown="onkeydownAmount($event)" @input="onChangeSupplies($event)"></v-text-field> -->
                                        <v-text-field outlined dense :rules="[RequiredRules.supplies]"
                                            v-model="rfFormData.supplies"
                                            :background-color="rfFormData.supplies ? inputBackGround : ''"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col cols="7" style="padding-bottom: 5px;padding-top: 0px;">
                                        <!-- <v-text-field outlined dense :rules="[RequiredRules.meals]"
                                            ...
                                            @keydown="onkeydownAmount($event)" @input="onChangeMeals($event)"></v-text-field> -->
                                        <v-text-field outlined dense :rules="[RequiredRules.meals]"
                                            v-model="rfFormData.meals"
                                            :background-color="rfFormData.meals ? inputBackGround : ''"
                                ...
                                <v-row align="baseline" class="mt-0">
                                    ...
                                    <v-col cols="7" style="padding-bottom: 5px;padding-top: 0px;">
                                        <!-- <v-text-field outlined dense :rules="[RequiredRules.others]"
                                            ...
                                            @keydown="onkeydownAmount($event)"  @input="onChangeOthers($event)"></v-text-field> -->
                                        <v-text-field outlined dense :rules="[RequiredRules.others]"
                                            v-model="rfFormData.others"
                                            :background-color="rfFormData.others ? inputBackGround : ''"
...
export default {
    ...
    created() {
        ...
        // this.periodYear = Array.from(new Set([...this.periodYear, this.selectedYear]));
    },
    mounted() {
    ...
    watch: {
        ...
        //     if (!this.periodYear.includes(newYear)) {
        //         this.periodYear.push(newYear);
    ...
    computed: {
        ...
        //         // total = parseFloat(this.rfFormData.transpo.replace(/,/g, '')) + parseFloat(this.rfFormData.supplies.replace(/,/g, '')) + parseFloat(this.rfFormData.meals.replace(/,/g, '')) + parseFloat(this.rfFormData.others.replace(/,/g, ''));
        //         total = this.rfFormData.transpo + this.rfFormData.supplies
        //         console.log(total);
        //         // result = total.toString().replace(/\D/g, "")
        //         //     .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        //         // console.log(result);
        ...
        // },
        // UpdatecashOnHand() {
        //     if (this.rfFormData.rfAllowance == null || this.rfFormData.totalExpenses == null) {
        //         return 0
        ...
        //         let cash = parseAllowance - parseTotal
        //         console.log(cash);
        ...
        //         } else {
        //             console.log(cash);
        //             let result = cash.toString().replace(/\D/g, "")
        //                 .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        //             console.log(result);
        //             return result
        //         }
    ...
    methods: {
        ...
        //     .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        // this.rfFormData.rfAllowance = result
        // },
        // onChangeTranspo(e) {
        //     let result = e.toString().replace(/\D/g, "")
        //         .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        //     this.rfFormData.transpo = result
        // },
        // onChangeSupplies(e) {
        //     let result = e.toString().replace(/\D/g, "")
        //         .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        //     this.rfFormData.supplies = result
        // },
        // onChangeMeals(e) {
        //     let result = e.toString().replace(/\D/g, "")
        //         .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        //     this.rfFormData.meals = result
        // },
        // onChangeOthers(e) {
        //     let result = e.toString().replace(/\D/g, "")
        //         .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        //     this.rfFormData.others = result
        // },
